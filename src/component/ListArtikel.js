...
const ListArtikel = () => {
  const [DataListArtikel, setDataListArtikel] = useState([]);
        ...
        <Row>
          <Col xs={8}>
            <div className="artikel-terkini">
              ...
              {console.log("console ListArtikel :" + DataListArtikel)}
              {DataListArtikel &&
                DataListArtikel.map((item, index) => {
                  return (
                    <Row>
                      <Col xs={12}>
          ...
          <Col xs={4}>
            ...
            <div className="artikel-terkini1">
